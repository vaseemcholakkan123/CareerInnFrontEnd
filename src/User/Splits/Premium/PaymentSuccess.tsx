...
function PaymentSuccess() {
    return (
        <div className='h-100 bg-white app-shadow app-font r-7'>
            <div className="p-2 d-flex a-center f-coloumn pt-md-3 pt-2">
                <h3 className='weight-700 resize-heading text-success'>Payment Success</h3>
                <svg className='mt-3 mb-3' xmlns="http://www.w3.org/2000/svg" width="220.17" height="215.858" viewBox="0 0 220.17 215.858">
                ...
                <p className='ps-3 pe-3 pt-3'>Your payment has been successful</p>
                <p className='f-small app-color'> please login again to enjoy premium benefits.</p>
