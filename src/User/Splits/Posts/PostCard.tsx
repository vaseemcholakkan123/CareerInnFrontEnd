...
function PostCard({ post, deletepost, updatePost, reportPost, updateSaved }: { post: post, deletepost: (post_id: number) => void, updatePost: (c_text: string, c_image: string | null, post_id: number) => void, reportPost: (post_id: number) => void, updateSaved: (p: number) => void }) {
    ...
    return (
        <div className={post.id == post_id ? 'col-12 mb-3 post-card app-shadow app-blue-gray' : 'col-12 mb-3 post-card app-shadow'}>
            ...
            <div className="actions-holder">
                {
                    is_liked ?
                        ...
                        <div className="action" onClick={() => {
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" id="like-creation-medium" data-supported-dps="24x24">
                                <g>
            ...
            <div>
                <div className="display-flex a-center ms-1 me-1 pb-2 mt-2" id={ShowComment ? '' : 'hidden'}>
                    <img src={user.profile ? user.profile : default_user_image} width={45} height={45} className='rounded-circle me-2' alt="user_profile" />
                    <div className="like-input d-flex a-center also-input">
                        <form className='d-flex w-100' onSubmit={e => {
                            ...
                            <input type="text" name='comment' className='app-input' placeholder='Write feedback' />
                            <button type='submit' className="app-color app-link me-3 post-btn">
