            ...
            <div className={ActiveLayout == 'chats-selection' ? "col-sm-5 col-12 h-100 overflow-hidden d-sm-block" : "d-none col-sm-5 col-12 h-100 overflow-hidden d-sm-block"}>
                ...
                <div className="p-2 ps-2 pe-2">
                    <div className="bg-blg p-1 position-relative row a-center">
                        ...
                        <div className={Searchusers[0] ? 'search-results-holder p-1 d-flex f-coloumn gap-2' : ''}>
                            {
                                !searchLoading && Searchusers[0] ?
                                    Searchusers.map(usr => {
                                        return (
                                            <div
                                                key={usr.id}
                                                className="small-card-user d-flex gap-1"
                                                onClick={() => {
                                                    SetchatThreads([{ id: Math.random() * 99999, primary_user: { ...usr, profile: BASE_IMAGE_URL + usr.profile }, secondary_user: usr }, ...ChatThreads]);
                                                    SetSearchusers([])
                                                    SetchatActive({ ...usr, profile: BASE_IMAGE_URL + usr.profile })
                                                ...
                                                <div className='normal-line-height mt-1'>
                                    ...
                                    :
                                    Searchquery != '' && !searchLoading && <p className='text-center pb-2'> No results</p>
                        ...
                        ChatThreads.map(thread => {
                            return (
                                thread.primary_user.id == user.user_id ?
                                    ...
                                    <div
                                        key={thread.id}
                                        className={ActiveChat?.id == thread.secondary_user.id ? 'd-flex active-chat ps-2' : 'd-flex ps-2 n-active-chat'}
                                        onClick={() => {
                                        ...
                                        <div className='mt-md-1 mt-0 p-2 normal-line-height'>
                                            <div className="d-flex">
                                                <h6>{thread.secondary_user.username}</h6>
                                                {
                                                    thread.secondary_user.is_premium_user ?
                                    ...
                                    <div
                                        key={thread.id}
                                        className={ActiveChat?.id == thread.primary_user.id ? 'd-flex active-chat ps-2' : 'd-flex ps-2 n-active-chat'}
                                        onClick={() => {
                                        ...
                                        <div className='mt-1 p-2 normal-line-height'>
                                            <div className="d-flex">
                                                ...
                                                {
                                                    thread.primary_user.is_premium_user ?
                                                        <img src={verified_image} height={18} width={18} alt="" />
                                                        :
                                                        null
